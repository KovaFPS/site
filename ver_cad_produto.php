                ...
                <form method="post" action="alteracao_produto.php">
                    ...
                    <div class="form-row mb-3">
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" name="txtvalor_mercado" value='<?php echo $dado['valor_mercado']; ?>'>
                        </div>
                        <div class="form-group col-md-4">
                            <label for="exampleInputValorCustoMedio">Valor de Custo Médio</label>
                            <input type="text" class="form-control" name="txtvalor_custo_medio" value='<?php echo $dado['valor_custo_medio']; ?>'>
                        </div>
                    </div>
                    <!-- 3° linha -->
                    <div class="form-row mb-3">
                        <div class="col-md-12">
                            ...
                            <select class="form-control" name="txtonde_pega">
                    ...
                    <div class="text-center mt-3">
                        <button type="submit" class="btn m-2" style="background-color: #EE82EE; color:white; border-radius: 25px;"><i class="fas fa-pencil-alt"></i> Alterar</button>
                        <a href="ver_excluir_produto.php?codigo=<?php echo $dado['id']; ?>" class="btn btn-danger m-1" style="border-radius: 30px;" role="button">
